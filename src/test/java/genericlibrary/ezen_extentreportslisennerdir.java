...
public class ezen_extentreportslisennerdir implements ITestListener {
	...
	{
		ezen_webdrivergenericdir wLib  = new ezen_webdrivergenericdir();
		...
		new  ezen_webdrivergenericdir();
		test.addScreenCaptureFromBase64String(ezen_webdrivergenericdir.Base64takescreenshot(Test_BasePagelib.driver));
	...
	public void onTestFailure(ITestResult result) //fail
	{
		...
		try 
		{
			String path = wLib.takeScreenShot(Test_BasePagelib.driver, MethodName);
	...
	public void onStart(ITestContext context) {
		...
		ExtentSparkReporter htmlReport = new ExtentSparkReporter(".\\ExtentReports\\Report-"+ new ezen_webdrivergenericdir().getSystemDateInFormat()+".html");
